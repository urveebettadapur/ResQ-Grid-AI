    ...
    <header className="sticky top-0 z-50 bg-slate-900/95 backdrop-blur-md border-b border-slate-800 px-2 sm:px-4 py-2 shadow-2xl w-full">
      <div className="w-full max-w-[1700px] mx-auto flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          <div className="relative flex items-center justify-center w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-red-600 to-rose-700 shadow-lg shadow-red-500/20 border border-red-400/30">
        ...
        <div className="flex items-center gap-2 font-mono text-xs overflow-x-auto py-0.5">
          ...
          {/* Time badge */}
          <div className="hidden md:flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-slate-800/80 border border-slate-700/60 text-slate-300 text-[11px] shrink-0">
            <Clock className="w-3 h-3 text-blue-400" />
            <span>UTC+5:30 <strong className="text-white">{currentTime}</strong></span>
          </div>

          {/* Active SOS badge */}
          <div className="hidden sm:flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-red-500/10 border border-red-500/30 text-red-300 text-[11px] shrink-0">
          ...
          {/* Scenario Selector */}
          <div className="relative shrink-0 max-w-[200px] sm:max-w-xs md:max-w-sm">
            <select 
              value={activeScenarioKey}
              onChange={(e) => setActiveScenarioKey(e.target.value)}
              className="bg-slate-800 border border-slate-700 text-slate-200 text-xs rounded-lg px-2 py-1 pr-6 focus:outline-none focus:ring-1 focus:ring-red-500 cursor-pointer w-full truncate"
            >
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2 sm:px-2.5 py-1 rounded-lg bg-blue-600/20 hover:bg-blue-600/30 text-blue-300 border border-blue-500/30 text-xs font-semibold transition-all shrink-0"
          ...
          <button
            ...
            className="flex items-center gap-1 px-2 sm:px-2.5 py-1 rounded-lg bg-purple-600/20 hover:bg-purple-600/30 text-purple-300 border border-purple-500/30 text-xs font-semibold transition-all shrink-0"
